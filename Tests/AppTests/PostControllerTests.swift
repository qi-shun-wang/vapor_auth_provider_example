...
//        try fetchAll(expectCount: 0)
    ...
    func create() throws -> Int? {
        let req = Request.makeTest(method: .post,path:"posts")
    ...
    func fetchOne(id: Int) throws {
        let req = Request.makeTest(method: .get,path:"posts")
    ...
    func patch(id: Int) throws {
        let req = Request.makeTest(method: .patch,path:"posts")
    ...
    func put(id: Int) throws {
        let req = Request.makeTest(method: .put,path:"posts")
        req.json = try JSON(node: ["content": updatedMessage])
        let post = try Post.find(id)!
    ...
    func deleteOne(id: Int) throws {
        let req = Request.makeTest(method: .delete,path:"posts")
